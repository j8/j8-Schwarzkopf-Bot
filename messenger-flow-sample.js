...
function sendQuickReply(USER_ID) {
  var messageData = {
    recipient: {
      id: USER_ID
    },    "message":{
    ...
    data.entry.forEach(entry => {
      entry.messaging.forEach(event => {
        if (event.message && !event.message.is_echo) {
          ...
          console.log("do I receive message???", event.message);
          ...
          if (attachments && sessions[sessionId].context == 'upload') {
            ...
            switch(event.message.quick_reply.payload) {
              ...
              case 'GREY_SOME_ALL':
                  ...
                  var messageData = {
                    recipient: {
                      ...
                      "text":"Would you like to change your color or try differnt shades of your current color?",
                      "quick_replies":[
                        {
                          "content_type":"text",
                          "title":"Change color",
                          "payload":"CHANGE_COLOR"
                        },
                        {
                          "content_type":"text",
                          "title":"Try shades",
              ...
              case 'CHANGE_COLOR':
                  sessions[sessionId].context = 'change_color'

                  var messageData = {
                    recipient: {
                      id: sender
                    },    "message":{
                      "text":"What color do you want to become?",
                      "quick_replies":[
                        {
                          "content_type":"text",
                          "title":"Black",
              ...
              case 'TRY_SHADES':
                  sessions[sessionId].context = 'try_shades'
